...
public class TAgentChangelogQueueService {

  public interface Iface {

    public boolean addQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue) throws org.apache.thrift.TException;

    public crdhn.queue.data.TAgentChangelogQueue deQueue() throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void addQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean addQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue) throws org.apache.thrift.TException
    {
      send_addQueue(changelogQueue);
      return recv_addQueue();
    }

    public void send_addQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue) throws org.apache.thrift.TException
    {
      addQueue_args args = new addQueue_args();
      args.setChangelogQueue(changelogQueue);
    ...
    public crdhn.queue.data.TAgentChangelogQueue recv_deQueue() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addQueue_call method_call = new addQueue_call(changelogQueue, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class addQueue_call extends org.apache.thrift.async.TAsyncMethodCall {
      private crdhn.queue.data.TAgentChangelogQueue changelogQueue;
      public addQueue_call(crdhn.queue.data.TAgentChangelogQueue changelogQueue, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.changelogQueue = changelogQueue;
      }
    ...
    public static class deQueue_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public crdhn.queue.data.TAgentChangelogQueue getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addQueue<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addQueue_args> {
      ...
      public addQueue_result getResult(I iface, addQueue_args args) throws org.apache.thrift.TException {
        addQueue_result result = new addQueue_result();
        result.success = iface.addQueue(args.changelogQueue);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addQueue<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addQueue_args, Boolean> {
      ...
      public void start(I iface, addQueue_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.addQueue(args.changelogQueue,resultHandler);
      }
    }

    public static class deQueue<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deQueue_args, crdhn.queue.data.TAgentChangelogQueue> {
      public deQueue() {
        super("deQueue");
      }
      ...
      public AsyncMethodCallback<crdhn.queue.data.TAgentChangelogQueue> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<crdhn.queue.data.TAgentChangelogQueue>() { 
          public void onComplete(crdhn.queue.data.TAgentChangelogQueue o) {
            deQueue_result result = new deQueue_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, deQueue_args args, org.apache.thrift.async.AsyncMethodCallback<crdhn.queue.data.TAgentChangelogQueue> resultHandler) throws TException {
  ...
  public static class addQueue_args implements org.apache.thrift.TBase<addQueue_args, addQueue_args._Fields>, java.io.Serializable, Cloneable, Comparable<addQueue_args>   {
    ...
    private static final org.apache.thrift.protocol.TField CHANGELOG_QUEUE_FIELD_DESC = new org.apache.thrift.protocol.TField("changelogQueue", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public crdhn.queue.data.TAgentChangelogQueue changelogQueue; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      CHANGELOG_QUEUE((short)1, "changelogQueue");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // CHANGELOG_QUEUE
            return CHANGELOG_QUEUE;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.CHANGELOG_QUEUE, new org.apache.thrift.meta_data.FieldMetaData("changelogQueue", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, crdhn.queue.data.TAgentChangelogQueue.class)));
    ...
    public addQueue_args(
      crdhn.queue.data.TAgentChangelogQueue changelogQueue)
    {
      this();
      this.changelogQueue = changelogQueue;
    }
    ...
    public addQueue_args(addQueue_args other) {
      if (other.isSetChangelogQueue()) {
        this.changelogQueue = new crdhn.queue.data.TAgentChangelogQueue(other.changelogQueue);
      }
    }
    ...
    @Override
    public void clear() {
      this.changelogQueue = null;
    }

    public crdhn.queue.data.TAgentChangelogQueue getChangelogQueue() {
      return this.changelogQueue;
    }

    public addQueue_args setChangelogQueue(crdhn.queue.data.TAgentChangelogQueue changelogQueue) {
      this.changelogQueue = changelogQueue;
      return this;
    }

    public void unsetChangelogQueue() {
      this.changelogQueue = null;
    }

    /** Returns true if field changelogQueue is set (has been assigned a value) and false otherwise */
    public boolean isSetChangelogQueue() {
      return this.changelogQueue != null;
    }

    public void setChangelogQueueIsSet(boolean value) {
      if (!value) {
        this.changelogQueue = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case CHANGELOG_QUEUE:
        if (value == null) {
          unsetChangelogQueue();
        } else {
          setChangelogQueue((crdhn.queue.data.TAgentChangelogQueue)value);
        }
        break;
    ...
    public boolean equals(addQueue_args that) {
      ...
      boolean this_present_changelogQueue = true && this.isSetChangelogQueue();
      boolean that_present_changelogQueue = true && that.isSetChangelogQueue();
      if (this_present_changelogQueue || that_present_changelogQueue) {
        if (!(this_present_changelogQueue && that_present_changelogQueue))
          return false;
        if (!this.changelogQueue.equals(that.changelogQueue))
          return false;
      }
    ...
    public int compareTo(addQueue_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetChangelogQueue()).compareTo(other.isSetChangelogQueue());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetChangelogQueue()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.changelogQueue, other.changelogQueue);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("changelogQueue:");
      if (this.changelogQueue == null) {
        sb.append("null");
      } else {
        sb.append(this.changelogQueue);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (changelogQueue != null) {
        changelogQueue.validate();
      }
    }
    ...
    private static class addQueue_argsStandardScheme extends StandardScheme<addQueue_args> {
          ...
          switch (schemeField.id) {
            case 1: // CHANGELOG_QUEUE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.changelogQueue = new crdhn.queue.data.TAgentChangelogQueue();
                struct.changelogQueue.read(iprot);
                struct.setChangelogQueueIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addQueue_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.changelogQueue != null) {
          oprot.writeFieldBegin(CHANGELOG_QUEUE_FIELD_DESC);
          struct.changelogQueue.write(oprot);
          oprot.writeFieldEnd();
        }
...
;
  ...
  public static class deQueue_result implements org.apache.thrift.TBase<deQueue_result, deQueue_result._Fields>, java.io.Serializable, Cloneable, Comparable<deQueue_result>   {
    ...
    public crdhn.queue.data.TAgentChangelogQueue success; // required
    ...
    public deQueue_result(
      crdhn.queue.data.TAgentChangelogQueue success)
    {
      this();
      this.success = success;
    }
    ...
    public deQueue_result(deQueue_result other) {
      if (other.isSetSuccess()) {
        this.success = new crdhn.queue.data.TAgentChangelogQueue(other.success);
      }
    }
    ...
    public crdhn.queue.data.TAgentChangelogQueue getSuccess() {
      return this.success;
    }

    public deQueue_result setSuccess(crdhn.queue.data.TAgentChangelogQueue success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((crdhn.queue.data.TAgentChangelogQueue)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, deQueue_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new crdhn.queue.data.TAgentChangelogQueue();
