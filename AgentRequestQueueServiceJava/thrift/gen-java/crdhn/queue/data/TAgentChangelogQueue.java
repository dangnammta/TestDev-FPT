...
public class TAgentChangelogQueue implements org.apache.thrift.TBase<TAgentChangelogQueue, TAgentChangelogQueue._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentChangelogQueue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TAgentChangelogQueue");
  ...
  private static final org.apache.thrift.protocol.TField AGENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("agentId", org.apache.thrift.protocol.TType.I32, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TAgentChangelogQueueStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TAgentChangelogQueueTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TAgentChangelogQueue.class, metaDataMap);
  }

  public TAgentChangelogQueue() {
    this.dbId = -1;
   ...
   */
  public TAgentChangelogQueue(TAgentChangelogQueue other) {
  ...
  public TAgentChangelogQueue deepCopy() {
    return new TAgentChangelogQueue(this);
  }
  ...
  public TAgentChangelogQueue setDbId(int dbId) {
    this.dbId = dbId;
    setDbIdIsSet(true);
    return this;
  }
  ...
  public TAgentChangelogQueue setFileName(String fileName) {
    this.fileName = fileName;
    return this;
  }
  ...
  public TAgentChangelogQueue setAgentId(int agentId) {
    this.agentId = agentId;
    setAgentIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TAgentChangelogQueue)
      return this.equals((TAgentChangelogQueue)that);
    return false;
  }

  public boolean equals(TAgentChangelogQueue that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TAgentChangelogQueue other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TAgentChangelogQueue(");
    boolean first = true;
  ...
  private static class TAgentChangelogQueueStandardSchemeFactory implements SchemeFactory {
    public TAgentChangelogQueueStandardScheme getScheme() {
      return new TAgentChangelogQueueStandardScheme();
    }
  }

  private static class TAgentChangelogQueueStandardScheme extends StandardScheme<TAgentChangelogQueue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TAgentChangelogQueue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentChangelogQueue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TAgentChangelogQueueTupleSchemeFactory implements SchemeFactory {
    public TAgentChangelogQueueTupleScheme getScheme() {
      return new TAgentChangelogQueueTupleScheme();
    }
  }

  private static class TAgentChangelogQueueTupleScheme extends TupleScheme<TAgentChangelogQueue> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TAgentChangelogQueue struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TAgentChangelogQueue struct) throws org.apache.thrift.TException {
